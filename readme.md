...
0. Tests (controllers/Favorite.js + molecules/ArticlePreview.js(click) + molecules/TagList.js + molecules/ArticleFeedToggle.js + molecules/Pagination.js + organisms/ListArticlePreviews.js)
1. login
2. register
3. settings
4. editor

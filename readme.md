...
0. Tests (controllers/Favorite.js + controllers/GetTags.js + molecules/ArticlePreview.js + molecules/TagList.js + molecules/ArticleFeedToggle.js + organisms/ListArticlePreviews.js)
1. home (Pagination)
2. login
3. register
4. settings

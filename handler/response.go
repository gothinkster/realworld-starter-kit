...
func newArticleResponse(userID uint, a *model.Article) *singleArticleResponse {
...
func newCommentResponse(userID uint, cm *model.Comment) *singleCommentResponse {
	...
	comment.Author.Following = cm.User.FollowedBy(userID)
	return &singleCommentResponse{comment}
}

func newCommentListResponse(userID uint, comments []model.Comment) *commentListResponse {
	...
	for _, i := range comments {
		...
		cr.Author.Following = i.User.FollowedBy(userID)

...
public class CommentRestController {
    ...
    public CommentRestController(CommentService commentService, ArticleService articleService, FollowStateService followStateService) {
    ...
    public CommentCreateResponse addCommentToArticle(
        ...
        Comment registeredComment = commentService.registerComment(loginUser, article, request.getBody());
    ...
    public MultipleCommentResponse getComments(@PathVariable String slug, @AuthenticationPrincipal Object principal){

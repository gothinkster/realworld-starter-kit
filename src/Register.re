        ...
        Form.(
          <FormBody
            ...
            onUsernameChange={event =>
              event |> Formality.Dom.toValueOnChange |> form.change(Username)
            }
            onUsernameBlur={event =>
              event |> Formality.Dom.toValueOnBlur |> form.change(Username)
            }
            email={form.state.email}
            onEmailChange={event =>
              event |> Formality.Dom.toValueOnChange |> form.change(Email)
            }
            onEmailBlur={event =>
              event |> Formality.Dom.toValueOnBlur |> form.change(Email)
            }
            password={form.state.password}
            onPasswordChange={event =>
              event |> Formality.Dom.toValueOnChange |> form.change(Password)
            }
            onPasswordBlur={event =>
              event |> Formality.Dom.toValueOnBlur |> form.change(Password)
            }

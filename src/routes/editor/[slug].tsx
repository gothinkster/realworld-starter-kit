...
import { createComputed, createEffect, For, onMount, Show, Suspense } from 'solid-js'
...
export default () => {
	...
	const updateState =
		(field: keyof EditorState) => (ev: { target: HTMLInputElement | HTMLTextAreaElement }) =>
	...
	const handleTagInputKeyDown = (ev: { keyCode: number; preventDefault: () => void }) => {
		switch (ev.keyCode) {
			case 13: // Enter
			case 9: // Tab
			case 188: // ,
